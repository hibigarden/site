...
`u` and `Ctrl-r` use the document's shared undo and redo history, including edits made in other views. Switching views or temporarily disabling Vim does not reset that history.
